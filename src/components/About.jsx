        ...
        <div className="grid-2" style={{ alignItems: 'center', marginBottom: '80px' }}>
          ...
          <div style={{ textAlign: 'left' }}>
            <h3 style={{ marginBottom: '20px', color: 'var(--color-text-title)', fontSize: '1.35rem', lineHeight: '1.4' }}>
              "Chúng mình là G4U" – Trạm dừng chân của những tâm hồn yêu nhạc tại TDTU! 🎸
            </h3>
            <p style={{ color: 'var(--color-text)', marginBottom: '16px', fontSize: '1rem', lineHeight: '1.6' }}>
              Không chỉ là sân chơi rèn luyện kỹ năng cho các bạn đam mê Guitar, G4U còn là mái nhà chung rộng mở đón chào các tài năng Vocal, Cajon, Keyboard, Bass,... cùng nhau "cháy" hết mình trong các buổi sinh hoạt hàng tuần, hát giao lưu sảnh trường và cả những liveshow hoành tráng.
            </p>
            ...
            <ul style={{ listStyleType: 'none', paddingLeft: '0', marginBottom: '16px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
              <li style={{ fontSize: '0.95rem', color: 'var(--color-text)', lineHeight: '1.5' }}>
                <strong style={{ color: 'var(--color-primary)' }}>• Ban Sự kiện:</strong> Những "tổng tư lệnh" năng nổ, lo liệu từ A-Z để mọi chương trình luôn mượt mà và hoành tráng.
              </li>
              <li style={{ fontSize: '0.95rem', color: 'var(--color-text)', lineHeight: '1.5' }}>
                <strong style={{ color: 'var(--color-secondary)' }}>• Ban Truyền thông:</strong> Đội ngũ "phù thủy" sáng tạo nội dung, hình ảnh giúp lan tỏa mạnh mẽ ngọn lửa đam mê của G4U.
              </li>
              <li style={{ fontSize: '0.95rem', color: 'var(--color-text)', lineHeight: '1.5' }}>
                <strong style={{ color: 'var(--color-accent)' }}>• Ban Đối ngoại:</strong> Những "đại sứ" nhạy bén, chuyên săn "deal" xịn và giữ vai trò cầu nối vững chắc với các đối tác, nhà tài trợ.
              </li>
            </ul>
            <p style={{ color: 'var(--color-text-title)', marginBottom: '24px', fontSize: '1rem', lineHeight: '1.6', fontWeight: '600' }}>
              Dù bạn đam mê tỏa sáng dưới ánh đèn sân khấu hay thích làm "hậu phương" vững chắc vạch định chiến lược, G4U luôn có một vị trí dành riêng cho bạn. Cùng gia nhập và viết nên thanh xuân rực rỡ tại TDTU nhé!
            </p>
