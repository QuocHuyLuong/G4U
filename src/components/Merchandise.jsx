    ...
    fetch('/merchandise/merchandise.json')
      ...
      .catch(err => {
        ...
        setMerchItems([
          ...
          {
            id: 2,
            name: "Dây đeo Guitar / Thẻ sinh viên G4U",
            tag: "Phụ kiện độc quyền",
            description: "Phụ kiện dây đeo thiết kế độc quyền của G4U, sử dụng làm dây đeo thẻ sinh viên hoặc dây đeo guitar, thể hiện cá tính yêu âm nhạc ở mọi nơi.",
